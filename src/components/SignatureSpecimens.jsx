    ...
    <section className="animate-fade-up rounded-[2rem] border border-line bg-gradient-to-br from-stone-950 via-ink to-black/80 p-6 text-white shadow-xl shadow-black/30 sm:p-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {specimens.map((specimen) => (
          <article key={specimen.title} className="group animate-fade-up overflow-hidden rounded-[2rem] border border-white/10 bg-black/60 transition hover:-translate-y-1 hover:border-gold/25 hover:bg-slate-950/80">
